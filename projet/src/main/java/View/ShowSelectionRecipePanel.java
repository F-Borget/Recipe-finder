...
public class ShowSelectionRecipePanel {

	JPanel formPanel;
	JPanel recipeDetailPanel;

	public ShowSelectionRecipePanel(JPanel detailedRecipePanel_) {
	...
	public void recipeDetailPanelDisposition(RecipeAPI recipe) {
		...
		// Nom de la recette
		JTextArea nameTextArea = new JTextArea(recipe.getTitle());
		nameTextArea.setEditable(false);
		nameTextArea.setLineWrap(true);
		nameTextArea.setWrapStyleWord(true);
		nameTextArea.setFont(new Font("Arial", Font.BOLD, 18));
		nameTextArea.setBackground(Color.decode("#EEE2DF"));
		...
		recipeMainPanel.add(recipePicturePanel, BorderLayout.NORTH);
