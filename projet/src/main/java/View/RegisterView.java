...
public class RegisterView {
    ...
    public void buildFrame() {
        ...
        icon = new ImageIcon("images\\logo_register.png");
        img = icon.getImage();
    ...
    private void setBound() {
        ...
        registerButton.setBounds(70, 350, 100, 30);
        registerButton.setBackground(new Color(110, 215, 40));
    ...
    private void addButtonEvents(){
        //loginButton.setActionCommand("goToLoginPage");
        ...
        registerButton.addActionListener(new LoginEventHandler(usernameField, emailField,passwordField,revealPassword,frame));
